...
if ( ! class_exists( 'Wc_Compralo_Environment' ) ) {
 ...
 */
	 ...
	 */
		...
		$this->_woocommerce_version      = Wc_Compralo_Helper::woocommerce_version();
	 ...
	 */
		...
		$all_required_plugins       = array_flip( $all_required_plugins );
		$all_active_plugins         = Wc_Compralo_Helper::wordpress_plugins();
		$remaining_plugins_required = array_diff_key( $all_required_plugins, $all_active_plugins );

		if ( ! empty( $active_required_plugins ) ) :
